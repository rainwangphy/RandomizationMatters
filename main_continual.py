...
import compact.callbacks as cb
import compact.evaluate as evaluate
import compact.utils as utils
import compact.visual_plt as visual_plt
from compact.continual_learner import ContinualLearner
from compact.data import get_multitask_experiment
from compact.encoder import Classifier
from compact.exemplars import ExemplarHandler
from compact.param_stamp import get_param_stamp, get_param_stamp_from_args
from compact.param_values import set_default_values
from compact.replayer import Replayer
from compact.train import train_cl
from compact.vae_models import AutoEncoder

parser = argparse.ArgumentParser('./main_continual.py', description='Run individual continual learning experiment.')
